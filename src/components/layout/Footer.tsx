...
const socialLinks = [
  { icon: MessageCircle, href: import.meta.env.VITE_SOCIAL_TELEGRAM || 'https://t.me/phantom', label: 'Telegram' },
  { icon: Twitter, href: import.meta.env.VITE_SOCIAL_TWITTER || 'https://twitter.com/phantom', label: 'Twitter' },
  { icon: Github, href: import.meta.env.VITE_SOCIAL_GITHUB || 'https://github.com/phantom', label: 'GitHub' },
  { icon: Mail, href: import.meta.env.VITE_CONTACT_EMAIL || 'mailto:hello@phantom.net', label: 'Email' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href={import.meta.env.VITE_CONTACT_EMAIL || 'mailto:hello@phantom.net'}
                className="flex items-center gap-2 text-phantom-purple text-sm hover:underline"
              >
                <Mail className="w-4 h-4" />
                {(import.meta.env.VITE_CONTACT_EMAIL || 'hello@phantom.net').replace('mailto:', '')}
              </a>
