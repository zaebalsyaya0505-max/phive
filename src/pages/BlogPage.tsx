...
export default function BlogPage() {
  ...
  const featuredPost = {
    ...
    excerpt: 'Deep Packet Inspection — один из главных инструментов цензуры в современном интернете. Разбираем, как pHive обоходит DPI-системы и защитает ваш трафик от анализа.',
    date: '12 января 2026',
    readTime: '8 минут',
    icon: Shield,
    category: 'Технологии',
  ...
  const posts = [
    ...
    {
      title: 'TON-платежи в pHive: безопасно и быстро',
    ...
    },
    {
      ...
      excerpt: 'pHive открывает рекламную сеть с доступом к 100K+ активным пользователям ежедневно.',
    ...
    {
      title: 'Rust в pHive: почему мы выбрали этот язык',
      excerpt: 'Рассказываем, почему для ядра pHive был выбран Rust и какие преимущества это даёт.',
    ...
    },
    {
      ...
      excerpt: 'Пошаговое руководство по использованию pHive в странах с жёсткой интернет-цензурой.',
