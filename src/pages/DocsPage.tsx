...
const faqData: Record<string, FAQItem[]> = {
  users: [
    {
      question: 'Как установить pHive на Android?',
    ...
    },
    {
      ...
      answer: 'pHive использует P2P Mesh-сеть для распространения обновлений. Даже если ваш провайдер ограничивает доступ к серверам обновлений, приложение получает новые версии через других пользователей сети — напрямую, без центрального сервера.',
    },
    {
    ...
    {
      question: 'Насколько безопасен pHive?',
      answer: 'pHive использует TLS 1.4 с Perfect Forward Secrecy, пост-квантовую криптографию ML-KEM/ML-DSA (стандарты NIST 2024), и Signal Protocol v4 для end-to-end шифрования сообщений. Мы не собираем логи активности и не храним данные пользователей на центральных серверах.',
    },
  ],
  advertisers: [
    {
    ...
    },
    {
      ...
      answer: 'pHive работает в 50+ странах. Наибольшая концентрация пользователей в СНГ, Азии, Ближнем Востоке и Латинской Америке. Можно настроить таргетинг по стране, городу и даже провайдеру.',
    },
  ],
  developers: [
    {
      question: 'Как получить API-ключ?',
      answer: 'Зарегистрируйтесь как партнёр на странице partners.phive.net. После верификации вам будет выдан API-ключ с доступом к выбранным эндпоинтам.',
    },
    {
